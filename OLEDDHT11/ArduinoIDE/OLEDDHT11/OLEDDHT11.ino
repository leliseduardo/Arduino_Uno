/* 
            ...
            Este código é copiado do professor, e tem a funçãode imprimir no display OLED os dados lidos pelo sensor DHT11, que são umidade e temperatura. Utilizando a 
       interrupção do timer2, o código faz uma temporização que altera o display para mostrar ora a temperatura, ora a umidade. 
