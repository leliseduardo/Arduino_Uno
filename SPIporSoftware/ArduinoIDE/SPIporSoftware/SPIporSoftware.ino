/* =====================================================================================================
   ...
   Este código é copiado do professor e tem a função de explicar e demonstrar como funciona a comunicação SPI. Assim, torna-se possível não utilizar as bibliotecas já prontas.
