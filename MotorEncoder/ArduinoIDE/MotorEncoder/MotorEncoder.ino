/*
            ...
            Este código foi copiado do professor. Ele utiliza um motor que tem um encoder conectado ao seu eixo e, para controlar um motor, utiliza o driver para motores DC
     L293D. O programa tem a função de controlar a velocidade no sentido horário quando o potenciômetro está de VCC até seu centro, parado quando o potenciômetro está no
     centro, e no sentido anti-horário quando o potenciômetro está do centro para GND. Para controlar a velocidade utiliza-se o PWM. Ainda, através do sinal gerado pelo
     potenciômetro no eixo do motor, é possível saber a velocidade do motor, podendo assim, desenvolver um controle inteligente que regula a velocidade do motor de acordo
