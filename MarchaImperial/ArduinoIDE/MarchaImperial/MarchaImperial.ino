/* 
          ...
          Este código foi copiado do professor, e demosntra como gerar uma melodia através de um buzzer piezo. No caso, a melodia criada foi a marcha
     imperial do filme Star Wars.
