...
void draw()
{
   ...
   int graph_val = map(temp_C,0,100,0,128);
   
   //desenha a barra gráfica
   u8g.drawFrame(0,pBar,  graph_val,2);           
   u8g.drawFrame(0,pBar+2,graph_val,2);       
   u8g.drawFrame(0,pBar+4,graph_val,2);
   u8g.drawFrame(0,pBar+6,graph_val,2);
